const tmin=310;const tmax=510;const n=3;repstep=1;const repstepmax=9999;analysis_interval=50
batch=1;const R=0.001986;const runlen=2000;const runn=1;sf="starting_files";
b1=cell(n);b2=cell(n);b3=cell(n);list=cell(n);
...
for repstep=1:repstepmax
	...
	println(rstat,(rs));close(rstat)
 	for rep=1:n
		...
		# Checking that abf_quench$rep.namd does exist..///////////////////////////////////
	  	...
	  	@async run(pipe(`./namd3 +idlepoll +p2 abf_quench$rep.namd`,"abf_quench$rep.out"))
	...
	# abf_quench_Epp$rep.namd and abf_quench_Epw$rep.namd..////////////////////////// 
 	for rep=1:n
 		run(pipe(`./namd2 +p2 abf_quenchEpp$rep.namd`,"abf_quenchEpp$rep.out"))
		run(pipe(`./namd2 +p2 abf_quenchEpw$rep.namd`,"abf_quenchEpw$rep.out"))
...
#...Get DCD array..//////////////////////////////////////////////////////////////////////	
	if repstep%analysis_interval==0 && repstep!=repstepmax
		include("readdcd2.jl")
		writedlm("output/trj$repstep.dat",trj)
	end
#...End..////////////////////////////////////////////////////////////////////////////////	
end
